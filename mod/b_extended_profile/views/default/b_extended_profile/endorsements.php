...
<div class="gcconnex-profile-section-wrapper gcconnex-endorsement-wrapper">
    ...
    <?php if (elgg_get_logged_in_user_entity() == elgg_get_page_owner_entity()) {
        ...
        echo '<span class="save-control save-endorsements hidden"><img src="' . elgg_get_site_url() . 'mod/b_extended_profile/img/save.png">Save</span>';
        echo '<span class="cancel-control cancel-endorsements hidden"><img src="' . elgg_get_site_url() . 'mod/b_extended_profile/img/cancel.png">Cancel</span>';
        echo '</span>';
    }
    ?>
